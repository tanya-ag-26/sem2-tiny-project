...
## 📂 Project Structure
project/ │ ├── app.py                # Flask app (routes, Gemini calls, orchestration) ├── templates/            # HTML files ├── static/               # CSS, JS, assets ├── .env                  # Secrets (NOT committed) ├── requirements.txt      # Dependencies ├── README.md
...
### 1) Clone
bash git clone https://github.com/tanya-ag-26/sem2-tiny-project.git cd sem2-tiny-project 
...
### 3) Environment
Create a .env file:
GENAI_API_KEY=your_gemini_api_key OPENWEATHER_API_KEY=your_weather_api_key NEWS_API_KEY=your_news_api_key FINNHUB_API_KEY=your_stock_api_key
...
Request
json {   "session_id": "user1",   "message": "What is the price of Bitcoin today?" } 

Response
json {   "reply": "Bitcoin price: $XXXXX USD (₹XXXXX INR)",   "search_used": true } 
